<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>确认密码:</label>
        <input type="password" placeholder="请输入确认密码" name="password1" v-model="password1" v-validate='{required:true,is:password}' :class="{invalid:errors.has('password1')}" />
        <span class="error-msg">{{errors.first('password1')}}</span>
      </div>
      <div class="controls">
        <input name="agree" type="checkbox" :checked="agree" v-model="agree" v-validate='{required:true,tongyi:true}' :class="{invalid:errors.has('agree')}"/>
